...
if __name__ == '__main__':
    ...
    try:
        gpt2_tok.save(args.output_dir, pretty=True) #FIX Access is denied. (os error 5)
    ...
    tokenizer = GPT2TokenizerFast(
        ...
        merges_file=os.path.join(args.output_dir,args.output_file_name) + "-merges.txt",
    ...
    tokenizer.save_pretrained(
        args.output_dir,
        legacy_format=False,
        filename_prefix=args.output_file_name)